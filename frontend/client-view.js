...
var sdkKey = ""; // enter you sdk key here

var url =
  "https://us04web.zoom.us/j/77492515002?pwd=4IaOCGTdgPsr3UQUYfE0Q3kII3B024.1"; // enter invite link here
...
var zakToken = "";
var leaveUrl =
  "file:///C:/Users/thari/OneDrive/Desktop/googleMeetResearch/meetingsdk-web-bot-sample/frontend/index.html";
...
function handleMediaCapturePermissionError(error) {
  if (error.errorCode == "1") {
    console.log("Media capture permission Active", error);
    startMediaCapture();
  } else {
...
function setupMediaCaptureListeners() {
  ZoomMtg.inMeetingServiceListener(
    ...
    handleMediaCapturePermissionChange
  );
  ZoomMtg.inMeetingServiceListener(
    "onMediaCaptureStatusChange",
    handleMediaCaptureStatusChange
  );
